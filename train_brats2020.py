import os
import numpy as np
from Model.custom_datagen import imageLoader
...
msk_list_train = os.listdir(train_mask_dir)

num_images = len(os.listdir(train_img_dir))

img_num = random.randint(0,num_images-1)
test_img = np.load(train_img_dir+img_list_train[img_num])
test_mask = np.load(train_mask_dir+msk_list_train[img_num])
...
#%%Optional step of finding the distribution of each class and calculating appropriate weights for the weighted crossentropy loss.
...
val_img_dir = "Data/BraTS2020_TrainingData/Final_data/val/images/"
val_mask_dir = "Data/BraTS2020_TrainingData/Final_data/val/masks/"

test_img_dir = "Data/BraTS2020_TrainingData/Final_data/test/images/"
test_mask_dir = "Data/BraTS2020_TrainingData/Final_data/test/masks/"
...
test_img_list=os.listdir(val_img_dir)
test_mask_list = os.listdir(val_mask_dir)
##################################
